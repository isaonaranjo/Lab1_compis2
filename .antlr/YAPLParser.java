...
public class YAPLParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_programBlock = 1, RULE_classDEF = 2, RULE_feature = 3, 
		RULE_formal = 4, RULE_expr = 5;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "programBlock", "classDEF", "feature", "formal", "expr"
		};
	}
	...
	public static class FeatureDEFContext extends FeatureContext {
		public TerminalNode OBJECTID() { return getToken(YAPLParser.OBJECTID, 0); }
		public TerminalNode TYPEID() { return getToken(YAPLParser.TYPEID, 0); }
		...
		public FeatureDEFContext(FeatureContext ctx) { copyFrom(ctx); }
	}
	...
	public final FeatureContext feature() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				break;
			case 2:
				_localctx = new FeatureDEFContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(58);
				match(OBJECTID);
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__3) | (1L << T__9) | (1L << T__14) | (1L << FALSE) | (1L << IF) | (1L << ISVOID) | (1L << WHILE) | (1L << NEW) | (1L << NOT) | (1L << TRUE) | (1L << STRINGS) | (1L << INTEGERS) | (1L << OBJECTID))) != 0)) {
					{
					setState(74);
					expr(0);
					setState(79);
			...
			case 4:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__3) | (1L << T__9) | (1L << T__14) | (1L << FALSE) | (1L << IF) | (1L << ISVOID) | (1L << WHILE) | (1L << NEW) | (1L << NOT) | (1L << TRUE) | (1L << STRINGS) | (1L << INTEGERS) | (1L << OBJECTID))) != 0)) {
					{
					{
					setState(100);
					expr(0);
	...
	public static final String _serializedATN =
		...
		"\2\26\25\3\2\2\2\27\5\3\2\2\2\30\31\7\25\2\2\31\34\7\'\2\2\32\33\7\33"+
		...
		"\2SQ\3\2\2\2TL\3\2\2\2TU\3\2\2\2UV\3\2\2\2V\u009b\7\b\2\2WX\7\31\2\2X"+
		"Y\5\f\7\2YZ\7 \2\2Z[\5\f\7\2[\\\7\26\2\2\\]\5\f\7\2]^\7\30\2\2^\u009b"+
		"\3\2\2\2_`\7!\2\2`a\5\f\7\2ab\7\36\2\2bc\5\f\7\2cd\7\37\2\2d\u009b\3\2"+
		"\2\2ek\7\4\2\2fg\5\f\7\2gh\7\3\2\2hj\3\2\2\2if\3\2\2\2jm\3\2\2\2ki\3\2"+
		"\2\2kl\3\2\2\2ln\3\2\2\2mk\3\2\2\2n\u009b\7\5\2\2op\7\f\2\2pq\7(\2\2q"+
		"r\7\t\2\2ru\7\'\2\2st\7)\2\2tv\5\f\7\2us\3\2\2\2uv\3\2\2\2v\u0081\3\2"+
		"\2\2wx\7\7\2\2xy\7(\2\2yz\7\t\2\2z}\7\'\2\2{|\7)\2\2|~\5\f\7\2}{\3\2\2"+
		"\2}~\3\2\2\2~\u0080\3\2\2\2\177w\3\2\2\2\u0080\u0083\3\2\2\2\u0081\177"+
		"\3\2\2\2\u0081\u0082\3\2\2\2\u0082\u0084\3\2\2\2\u0083\u0081\3\2\2\2\u0084"+
		"\u0085\7\32\2\2\u0085\u009b\5\f\7\25\u0086\u0087\7\"\2\2\u0087\u009b\7"+
		"\'\2\2\u0088\u0089\7\34\2\2\u0089\u009b\5\f\7\23\u008a\u008b\7\21\2\2"+
		...
		"\r\2\2\u009e\u00c5\5\f\7\23\u009f\u00a0\f\21\2\2\u00a0\u00a1\7\16\2\2"+
		"\u00a1\u00c5\5\f\7\22\u00a2\u00a3\f\20\2\2\u00a3\u00a4\7\17\2\2\u00a4"+
		"\u00c5\5\f\7\21\u00a5\u00a6\f\17\2\2\u00a6\u00a7\7\20\2\2\u00a7\u00c5"+
		"\5\f\7\20\u00a8\u00a9\f\r\2\2\u00a9\u00aa\7\22\2\2\u00aa\u00c5\5\f\7\16"+
		"\u00ab\u00ac\f\f\2\2\u00ac\u00ad\7\23\2\2\u00ad\u00c5\5\f\7\r\u00ae\u00af"+
		"\f\13\2\2\u00af\u00b0\7\24\2\2\u00b0\u00c5\5\f\7\f\u00b1\u00b4\f\32\2"+
		"\2\u00b2\u00b3\7\n\2\2\u00b3\u00b5\7\'\2\2\u00b4\u00b2\3\2\2\2\u00b4\u00b5"+
		"\3\2\2\2\u00b5\u00b6\3\2\2\2\u00b6\u00b7\7\13\2\2\u00b7\u00b8\7(\2\2\u00b8"+
